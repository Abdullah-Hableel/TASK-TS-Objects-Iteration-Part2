...
function addCourseToStudent(student: Student, course: string): Student {
  // write your code here...
  const addCourse = student.courses;
...
function countCourses(student: Student): number {
  // write your code here...
  //const countCourses = student.coursesc
...
function removeCourseFromStudent(student: Student, course: string): Student {
  // write your code here...
  // const removeCourseFromStudent = student.courses;
  // removeCourseFromStudent.filter((removeCourseFromStudent) => student.courses !== c );
